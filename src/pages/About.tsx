...
import { Users, Target, Award, BookOpen, Globe, Heart, Mail, Phone, MapPin } from "lucide-react";
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => <Card key={index} className="shadow-soft text-center">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => <Card key={index} className="shadow-soft text-center">
                <CardContent className="pt-6">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-4">
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={gamifiedLearning} title="Learn Through Gaming" description="Transform studying into an exciting adventure with XP points, hearts, streaks, and leaderboards that keep you motivated every step of the way." highlights={["XP Points", "Hearts System", "Daily Streaks", "Leaderboards"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={aiPowered} title="Smart AI Assistant" description="Your personal tutor that understands your learning style, generates personalized questions, and provides instant explanations." highlights={["AI Question Gen", "Smart Paths", "Instant Help", "Adaptive Learning"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={interactiveGames} title="8+ Game Types" description="Practice with engaging game-based questions including MCQ challenges, drag-drop, line matching, and typing races." highlights={["MCQ Games", "Drag & Drop", "Line Match", "Typing Race"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={analytics} title="Track Every Milestone" description="Know exactly where you stand with zone analysis, chapter-wise breakdowns, and performance trends." highlights={["Zone Analysis", "Chapter Stats", "Performance Trends", "Reports"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={roadmap} title="Guided Learning Path" description="Never wonder what to study next with our organized roadmaps, daily schedules, and topic progression tracking." highlights={["Daily Schedule", "Batch Roadmaps", "Topic Progress", "Calendar View"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={parentPortal} title="Parents Stay Connected" description="Keep parents in the loop with detailed insights into student progress, performance analytics, and daily activity tracking." highlights={["Progress Monitor", "Analytics", "Activity Tracking", "Reports"]} />
              </CarouselItem>
              
              <CarouselItem className="pl-4 md:basis-1/2 lg:basis-1/3">
                <FeatureShowcase icon={rewards} title="Earn While Learning" description="Get rewarded for bringing your friends to learn. Earn Jhakkas points and withdraw your earnings." highlights={["Referral Rewards", "Jhakkas Points", "Withdrawals", "Bonus XP"]} />
              </CarouselItem>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">​abhishek@jhakkaslearning.com
              </p>
              </div>
              <div className="space-y-2">
                <div className="w-10 h-10 mx-auto bg-primary/10 rounded-full flex items-center justify-center text-primary">
                ...
                <p className="text-sm text-muted-foreground">Soon be Available
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Zamania Tehsil ,232329 , UP</p>
              </div>
            </div>
