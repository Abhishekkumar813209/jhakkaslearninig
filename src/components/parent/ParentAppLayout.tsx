...
interface ParentAppLayoutProps {
  children: ReactNode;
}

export const ParentAppLayout = ({ children }: ParentAppLayoutProps) => {
        ...
        <div className="flex h-14 items-center justify-between px-4">
          ...
          <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
            ...
            <SheetContent side="left" className="w-72 p-0">
              <ParentAppSidebar onNavigate={() => setSidebarOpen(false)} />
            </SheetContent>
          </Sheet>
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold text-foreground">Jhakkas Parent</h1>
          </div>
